...
| `.erb`, `.rhtml` and `.herb` files in `erb/` | **36,977** from 268 apps |
| Size of `erb/` | ~57 MB |
...
**50 of 327** applications use Herb: `herb` 39, `@herb-tools/linter` 23, `@herb-tools/formatter` 14, `.herb.yml` 33, `.herb/` 1.
...
xychart
  ...
  y-axis "Apps" 0 --> 51
  line [3, 8, 12, 17, 21, 23, 25, 29, 32, 35, 41, 43, 50]
  line [0, 0, 2, 5, 8, 8, 8, 9, 10, 11, 11, 12, 13]
```

Herb 50 · ReActionView 13
...
Of the 33 Herb configs, the sections people set are `linter` (30), `formatter` (28), `version` (22), `files` (15), `framework` (4), `engine` (4), `template_engine` (2).

`formatter.maxLineLength`: **80** (15), **120** (8)
`formatter.indentWidth`: **2** (23)
