...
| `.erb`, `.rhtml` and `.herb` files in `erb/` | **36,395** from 268 apps |
| Size of `erb/` | ~56 MB |
...
**64 of 327** applications use Herb: `herb` 47, `@herb-tools/linter` 28, `@herb-tools/formatter` 16, `.herb.yml` 45, `.herb/` 1.
...
|  | formatter | ^0.10.2 | explicit | [2026-05-21](https://github.com/b3s/b3s/commit/86939a935e325232a4dc399430ba8a8a4c55fd95 "first seen in package.json") |
...
|  | linter | ^0.10.2 | explicit | [2026-03-27](https://github.com/solectrus/helios/commit/c28273af527a506a6bbd898c585d9c47fd1ce30b "first seen in package.json") |
...
|  | linter | https://pkg.pr.new/marcoroth/herb/@herb-tools/linter@5cce577 | explicit | [2025-10-16](https://github.com/rubyevents/rubyevents/commit/81996a0f5fcf530447e18ae735010deca69f9d4b "first seen in package.json") |
|  | formatter | https://pkg.pr.new/marcoroth/herb/@herb-tools/formatter@5cce577 | explicit | [2026-08-02](https://github.com/rubyevents/rubyevents/commit/0f3ae467e7c61d74a95af4b657671033cfcbdfd8 "first seen in package.json") |
...
**15 of 327** applications use ReActionView: `reactionview` 15.
...
xychart
  ...
  y-axis "Apps" 0 --> 65
  line [3, 8, 13, 18, 22, 25, 28, 35, 41, 46, 54, 57, 64]
  line [0, 0, 3, 6, 9, 9, 10, 11, 12, 13, 13, 14, 15]
```

Herb 64 · ReActionView 15
...
Of the 45 Herb configs, the sections people set are `linter` (42), `formatter` (40), `version` (32), `files` (16), `framework` (5), `engine` (4), `template_engine` (3).

`formatter.maxLineLength`: **80** (23), **120** (11)
`formatter.indentWidth`: **2** (34)
...
| `actionview-no-silent-helper` | 8 | 0 |
| `erb-no-unused-expressions` | 5 | 3 |
| `erb-no-instance-variables-in-partials` | 6 | 1 |
| `html-anchor-require-href` | 5 | 1 |
| `erb-no-interpolated-class-names` | 5 | 0 |
| `html-no-space-in-tag` | 1 | 4 |
| `erb-no-duplicate-branch-elements` | 5 | 0 |
| `erb-prefer-image-tag-helper` | 4 | 0 |
| `erb-no-unsafe-raw` | 3 | 1 |
...
**26 of 327** applications use `erb_lint` directly. 4 dropped it and now use Herb, and 12 run both.
...
**7 of 327** applications use `better_html` directly. 3 dropped it and now use Herb, and 4 run both.
...
**4 of 327** applications use `erb-formatter` directly. 5 dropped it and now use Herb, and 3 run both.
